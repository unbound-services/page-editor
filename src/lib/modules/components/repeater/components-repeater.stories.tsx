...
export const Dual_Repeaters: StoryObj<RepeaterProps> = {
  ...
  render: (args)=>{
    return <main><Repeater sectionName="pair"><span style={{border:"2px #00aaff solid", background:"#dddddd",padding:4,margin:4, display:"inline-block"}}><strong><EditorValue defaultValue={"title"} sectionName="title" /></strong></span></Repeater>
      <Repeater sectionName="pair"><div style={{background:"#dddddd",padding:8,margin:8}}><CE.h1 sectionName="title" /><p>Lorem Ipsum Amat Set Dolor</p></div></Repeater>
      <Repeater sectionName="footer"><div style={{display:"inline-block", background:"#dddddd",padding:8,margin:8}}><CE.h4 sectionName="title" /></div></Repeater>
      </main>},
